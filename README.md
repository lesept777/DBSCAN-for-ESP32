...
## Examples
Two examples are proposed, a [`simple`](https://github.com/lesept777/DBSCAN-for-ESP32/tree/main/examples/Simple)one to show the basics, and a more complex one with graphics that you can use on a [`TTGO`](https://github.com/lesept777/DBSCAN-for-ESP32/tree/main/examples/TTGO) T-display device. This example groups 2D points into 3 clusters (one in a circle in the center of the screen, and 2 around 2 circle arcs). You can use the buttons to change the values of epsilon and the tolerance of the points around the arcs, and GPIO15 to change the number of points in the dataset.
